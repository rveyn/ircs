...
static struct FeatureDesc {
  ...
  F_S(HIDDEN_HOST, FEAT_CASE, "users.staticbox.org", 0),
  ...
  F_S(HIS_SERVERNAME, 0, "irc.staticbox.org", feature_notify_servername),
  F_S(HIS_SERVERINFO, 0, "The Static Box IRC Network", feature_notify_serverinfo),
  F_S(HIS_URLSERVERS, 0, "http://www.staticbox.org", 0),

  /* Misc. random stuff */
  F_S(NETWORK, 0, "StaticBox", 0),
